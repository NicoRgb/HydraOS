#ifndef _LIBC_PRIVAT_VEC_H
#define _LIBC_PRIVAT_VEC_H
...
#define cvector_init(vec_ptr)                                                                         \
    {                                                                                                 \
        vec_ptr = malloc(sizeof(vec_ptr[0]) * _VEC_CAPACITY_INCREASAE + sizeof(vector_metadata_t *)); \
        vec_ptr += sizeof(vector_metadata_t *);                                                       \
        memset((void *)vec_ptr, 0, sizeof(sizeof((vec_ptr)[0]) * _VEC_CAPACITY_INCREASAE));           \
